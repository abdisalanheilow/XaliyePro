...
<body class="overflow-hidden">
    <div class="h-screen flex flex-col items-center justify-center py-6 px-4 sm:px-6 lg:px-8 overflow-y-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-300">Create your business account</p>
        </div>
        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-lg shadow-xl p-8">
                <div class="mb-6 text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Join the enterprise management ecosystem</p>
                </div>

                <form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{ loading: false }"
                    @submit="loading = true">
                    @csrf
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-bold text-[#28A375] hover:text-[#229967]">Sign In</a>
                    </p>
                </div>
            </div>
