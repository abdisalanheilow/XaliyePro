    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="isImportModalOpen" x-transition:enter="ease-out duration-300"
            ...
            <div
                ...
                <h3 class="text-xl font-bold text-gray-900">Import Brands</h3>
            ...
            <form action="{{ route('items.brands.import') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-blue-700 mb-2">Download the CSV template to see the required
                                        format</p>
                                    <a href="{{ route('items.brands.template') }}"
