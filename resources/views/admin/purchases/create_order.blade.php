...
@section('title', 'New Purchase Order - XaliyePro')
...
<form action="{{ route('purchases.orders.store') }}" method="POST" id="purchaseOrderForm" @submit="isSaving = true">
    @csrf
    <div class="space-y-6">
        <!-- Page Title -->
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Create a new order for procurement</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="reference_no" placeholder="Enter tracking code" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="expected_date" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                    </div>
                </div>
                ...
                <div class="flex items-end pb-1">
                    <p class="text-xs text-gray-400 italic">Verify order details before proceeding.</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <h2 class="text-lg font-bold text-gray-900">Terms & Special Instructions</h2>
                </div>
                <textarea name="notes" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] outline-none transition-all placeholder:text-gray-400" placeholder="Enter any specific requirements for this order..."></textarea>
            </div>
...
{{-- ADD VENDOR MODAL (REUSED FROM BILLS) --}}
