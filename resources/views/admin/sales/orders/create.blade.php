...
@section('title', 'New Sales Order - XaliyePro')
...
<form action="{{ route('sales.orders.store') }}" method="POST" id="salesOrderForm" @submit="isSaving = true">
    @csrf
    <div class="space-y-6">
        <!-- Page Title -->
        <div class="flex items-center justify-between mb-6">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    <a href="{{ route('sales.orders.index') }}" class="text-gray-500 hover:text-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <select name="customer_id" required class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                ...
                <div>
                    ...
                    <input type="text" name="order_no" value="{{ $orderNo }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg text-sm font-bold text-gray-600 focus:outline-none" readonly>
                </div>

                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Customer Reference</label>
                    <div class="relative group">
                        <i data-lucide="hash" class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 transition-colors"></i>
                        <input type="text" name="reference_no" placeholder="PO Number etc." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="order_date" value="{{ date('Y-m-d') }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="delivery_date" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] transition-all">
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <h2 class="text-lg font-bold text-gray-900">Notes & Terms</h2>
                </div>
                <textarea name="notes" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#28A375] outline-none transition-all placeholder:text-gray-400" placeholder="Special requirements for the customer..."></textarea>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-8 space-y-5 shadow-sm">
                ...
                <div class="flex items-center gap-6 py-2">
                    <div class="flex-1">
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Discount</label>
                        <div class="flex gap-2">
